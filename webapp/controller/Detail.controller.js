sap.ui.define([
	...
	return Controller.extend("opensap.movies.controller.Detail", {
		...
		_onDetailMatched: function(oEvent)
		{
			...
			oView.bindElement({
				path: "/movies/" + sMovieIndex + "/appointments/" + sAppointmentIndex, model: "movies", events: { change : this._onBindingChange.bind(this)}	
			});
		},
		_onBindingChange: function()
		{
			var oView = this.getView(), oElementBinding = oView.getElementBinding("movies"), sPath = oElementBinding.getPath();
